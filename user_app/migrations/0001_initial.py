    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rent_money', models.IntegerField(blank=True, max_length=20, null=True)),
                ('money_type', models.IntegerField(blank=True, max_length=20, null=True)),
                ...
                ('plot_size', models.IntegerField(blank=True, max_length=100, null=True)),
